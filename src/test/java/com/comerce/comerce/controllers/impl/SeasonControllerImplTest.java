 ...
 */
    ...
    void given_OkRequestAt10hWhen_tryToGetThen_getTheData() throws Exception {
        ...
        Mockito.when(priceRepository.findByproductIdAndCorporateIdAndEndDateIsAfterAndStartDateIsBefore(Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any())).thenReturn(createOptionalListPrice());
